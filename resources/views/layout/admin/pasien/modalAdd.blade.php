    ...
    <div id="add-pasien-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5" action="{{ route('admin.pasien.store') }}" method="POST">
                    @csrf
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="no_rm" id="no_rm"
                                class="p-2 border border-black rounded-md bg-gray-200" value="{{ $no_rm }}"
                                readonly>
                        </div>
                        <!-- Modal footer -->
                        <div class="flex items-center border-t py-5 border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="add-pasien-modal" type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I
                                accept</button>
                            <button data-modal-hide="add-pasien-modal" type="button"
