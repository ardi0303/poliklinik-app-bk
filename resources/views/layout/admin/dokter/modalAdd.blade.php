...
<body>
    <!-- Modal toggle -->
    <button data-modal-target="add-modal-dokter" data-modal-toggle="add-modal-dokter"
    ...
    <!-- Main modal -->
    <div id="add-modal-dokter" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="add-modal-dokter">
                ...
                <form class="p-4 md:p-5" action="{{ route('admin.dokter.store') }}" method="POST">
                    @csrf
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center border-t py-5 border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="add-modal-dokter" type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I
                                accept</button>
                            <button data-modal-hide="add-modal-dokter" type="button"
